    ...
    ui: {
        ...
        input: {
            variants: {
                variant: {
                    outline:
                        "text-support bg-[#171918] border-light-light-gray ring ring-inset ring-accented",
                    soft: "text-support bg-elevated/50 hover:bg-elevated focus:bg-elevated disabled:bg-elevated/50",
                    subtle: "text-support bg-elevated ring ring-inset ring-accented",
                    ghost: "text-support bg-transparent hover:bg-elevated focus:bg-elevated disabled:bg-transparent dark:disabled:bg-transparent",
                    none: "text-support bg-transparent",
                },
            },
        },
        drawer: {
